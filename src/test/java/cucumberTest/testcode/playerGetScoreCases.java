...
public class playerGetScoreCases {
    ...
    public void playerRollDiceAndGetTwoMonkeyTwoSkullTwoSwordTwoParrot() {
        String[] current = new String[8];
        for (int i=0; i<8; i++){               //roll die
            current[i] = game.rollSingleDie();
        }
    ...
    public void playerRerollTwoParrotAndGetTwoDiamond() {
        String[] hold = new String[] {"0", "1", "2", "3", "4", "5"};
        String[] newCurrent = game.RerollWithHold(game.player.getCurrentRoll(), hold);
        newCurrent[6] = "diamond";
        newCurrent[7] = "diamond";
        game.player.setCurrentRoll(newCurrent);
    }

    //row 68
    @And("Player roll dice and get two monkey two skull two sword one diamond one parrot")
    public void playerRollDiceAndGetTwoMonkeyTwoSkullTwoSwordOneDiamondOneParrot() {
        String[] current = new String[8];
        for (int i=0; i<8; i++){               //roll die
            current[i] = game.rollSingleDie();
        }
    ...
    @And("Player reroll two monkey and get two diamond")
    public void playerRerollTwoMonkeyAndGetTwoDiamond() {
        String[] hold = new String[] {"4", "5", "6", "7"};
        String[] newCurrent = game.RerollWithHold(game.player.getCurrentRoll(), hold);
        newCurrent[0] = "diamond";
        newCurrent[1] = "diamond";
        game.player.setCurrentRoll(newCurrent);
    }

    //row 70
    @And("Player roll dice and get one skull two coin one monkey one parrot three sword")
    public void playerRollDiceAndGetOneSkullTwoCoinOneMonkeyOneParrotThreeSword() {
        String[] current = new String[8];
        for (int i=0; i<8; i++){               //roll die
            current[i] = game.rollSingleDie();
        }
    ...
    public void playerRerollThreeSwordandGetOneCoinOneMonkeyOneParrot() {
        String[] hold = {"0", "1", "2", "3", "4"}; //select dice to hold
        String[] newCurrent = game.RerollWithHold(game.player.getCurrentRoll(), hold); //reroll
        //assign dice
        newCurrent[5] = "coin";
        newCurrent[6] = "monkey";
