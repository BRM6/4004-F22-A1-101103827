Feature: Player get a score number after all the movements
  ...
  @Row69
  Scenario: roll 2 (monkeys, skulls, swords), 1 diamond, 1 parrot, reroll 2 monkeys, get 2 diamonds, score 500
    When Player gets coin as FC for player get score
  ...
  @Row70
  Scenario: roll 1 skull, 2 coins, 1 (monkey/parrot), 3 swords, reroll 3 swords, get 1 (coin/monkey/parrot)  (SC 600)
    When Player gets coin as FC for player get score
  ...
  @Row71
  Scenario: roll 1 skull, 2 coins, 1 (monkey/parrot), 3 swords, reroll swords, get 1 (coin/monkey/parrot) with FC is diamond (SC 500)
    When Player gets diamond as FC for player get score
    And Player roll dice and get one skull two coin one monkey one parrot three sword
    And Player reroll three swordand get one coin one monkey one parrot
    Then Player score 500
